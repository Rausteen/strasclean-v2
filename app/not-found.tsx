      ...
      <main className="relative overflow-hidden">
        ...
        <div className="container-x py-16 sm:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="h-display mt-3 text-balance text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
              Cette page a roulé un peu trop loin.
            </h1>
            <p className="mt-4 text-balance text-[15px] leading-relaxed text-white/70 sm:text-lg">
          ...
          <div className="mx-auto mt-8 max-w-3xl rounded-2xl border border-white/10 bg-white/[0.03] p-5">
            ...
            <ul className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
              <li>
                ...
                >
                  <ArrowRightIcon size={12} className="text-brand-400" />
              ...
              <li>
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-white/80 hover:text-white"
                >
                  <ArrowRightIcon size={12} className="text-amber-400" />
            ...
            <p className="mt-5 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-center text-xs text-white/45">
