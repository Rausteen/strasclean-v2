    ...
    return (
      <div className="lg:hidden">
        <a
          ...
          className="flex items-center justify-center gap-2 border-b border-amber-500/30 bg-amber-500/10 px-4 py-2 text-[13px] font-medium text-amber-100 active:bg-amber-500/15"
        >
          <BoltIcon size={14} className="text-amber-300" />
          <span>
            <strong className="font-bold text-white">Dès 39 €</strong> · Canapé,
  ...
  return (
    <div className="lg:hidden">
      ...
      >
        ...
        <span>
          <strong className="font-bold text-white">Dès 39 €</strong> · Réponse
